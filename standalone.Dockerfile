...
# Remove SearxNG installation and configuration steps
# (All lines below are deleted)
...
# Set entrypoint to a default backend/frontend start command if needed
# (You may want to add your own entrypoint here)
